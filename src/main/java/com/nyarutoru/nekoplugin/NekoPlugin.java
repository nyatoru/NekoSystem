...
import com.nyarutoru.nekoplugin.features.sulfurcube.SulfurCubeFeature;
...
public class NekoPlugin extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        SulfurCubeFeature sulfurCubeFeature = new SulfurCubeFeature();
        ...
        FeatureManager.getInstance().registerFeature(sulfurCubeFeature);
